...
/**
 * Created by SEO on 12/21/2016.
 */

public class Custom_Search_List extends BaseAdapter {
    ...
    public Custom_Search_List(Context context, List<Bean_LaminateList> bean_laminateLists, Activity activity, ArrayList array_Listimage, ArrayList<String> favItemList,OnViewClickListener onViewClickListener) {
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        buyNow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                onViewClickListener.onShowInquiryDialog(bean_laminateLists.get(position).getLaminate_id());
            }
        });
    ...
    public void notifyDataSetChanged() {
        ...
        Log.d("Size in Adapter", bean_laminateLists.size() + "");
    }
            ...
            try {
                ...
                if (result_1.equalsIgnoreCase("")
                    ...
                    if (!date) {
                        ...
                        onViewClickListener.onViewClickSetFavorite(laminate_ID,true);
                    }
                }
            ...
            try {
                ...
                if (result_1.equalsIgnoreCase("")
                    ...
                    if (!date) {
                        ...
                        onViewClickListener.onViewClickSetFavorite(laminate_ID,false);
                    }
                }
            } catch (JSONException j) {
                j.printStackTrace();
