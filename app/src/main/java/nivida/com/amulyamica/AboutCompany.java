...
public class AboutCompany extends AppCompatActivity {
    ...
    private void fetchId() {
        ...
        String txtTitle="<font color=#666666>About </font><font color=#e77716>Company</font>";

      //  txtName.setText(Html.fromHtml(txtTitle));

        image=(ImageView)findViewById(R.id.image);

        new GetCMSInformation("7").execute();
    }
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if(!object.getBoolean("status")){
                    ...
                    txtName.setText(Html.fromHtml(newTitle));
